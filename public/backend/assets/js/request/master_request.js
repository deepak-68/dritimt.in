export const Request = {
    ...
    loadUserDatatable:function(){
        if ( ! $.fn.DataTable.isDataTable( '#request' ) ) {
            var columns     = [{"mData": "id"},{"mData": "name"},{"mData": "phone"},{"mData": "email"},{"mData": "course"},{"mData": "type"},{"mData": "created_at"},{"mData": "action"}];
            Request.LoadTable("request",columns);
        }
    },
    LoadTable: function(datatable,columns) {
        ...
        Request.FilterWithDatePicker(datatable1);
        Request.FilterWithName(datatable1);
        Request.FilterWithPhone(datatable1);
        Request.FilterWithCourse(datatable1);
        Request.FilterWithType(datatable1);
        Request.ClearFilter(datatable1);
     },
    ...
    FilterWithType:function(datatable1){
    ...
    ClearFillterBtnShow:function(){
     ...
     ClearFilter:function(datatable){ 
        $(document).on("click", ".clear-filter-btn", function () { 
            ...
            $("#form-container").find('#name').val('').trigger('change');
            $("#form-container").find('#phone').val('');
            $("#form-container").find('#course').val('');
            $("#form-container").find('#type').val('');
